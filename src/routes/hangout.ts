...
hangoutRouter.get('/:hangoutId', async (req, res) => {
  /*
...
hangoutRouter.put('/:hangoutId/addHomie/:homieId', async (req, res) => {
...
hangoutRouter.delete('/:hangoutId/removeHomie/:homieId', async (req, res) => {
  /*
  #swagger.responses[200] = {
